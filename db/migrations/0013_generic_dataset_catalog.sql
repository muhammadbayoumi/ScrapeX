-- ============================================================================
-- Migration 0013 — generic site, dataset, field and relationship catalogue.
--
...
-- Keyed on valid_to first: site_profile_id already has the primary key's
-- index, so leading with it made this one unusable for listing live sites.
