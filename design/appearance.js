(function () {
  ...
  const PALETTES = new Map([
    ["whatsapp", {
      id: "whatsapp",
      label: "WhatsApp",
      description: "Calm messaging green",
      colors: ["#0B141A", "#005C4B", "#00A884", "#D9FDD3"],
      themes: {
        light: {
          bg: "#F0F2F5", surface: "#FFFFFF", surfaceSubtle: "#F7F8FA",
          surfaceRaised: "#FFFFFF", line: "#E9EDEF", lineStrong: "#89979F",
          ...
          focus: "#006B5B", controlHover: "#F5F6F6",
        },
        dark: {
          bg: "#0B141A", surface: "#111B21", surfaceSubtle: "#182229",
          surfaceRaised: "#202C33", line: "#2A3942", lineStrong: "#647480",
          text: "#E9EDEF", muted: "#8696A0", textSubtle: "#768791",
