...
| **8** | **recoverable under R-83** — Arabic is the shorter side, and its observed labels identify the single omitted field without shifting later values |
...
serves, and 8 needed an Arabic-label-aware repair. **R-83 now builds that narrow repair**
