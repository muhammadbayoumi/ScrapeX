...
| Fetch an arbitrary origin (probe) | `scrapex/webui/app.py:1682` `@app.post("/api/probe")` | live network I/O | unchanged | Politeness, user-agent and pacing come from `crawl_settings` |
