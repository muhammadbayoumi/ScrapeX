...
**16 · 105 of the 1,497 addresses the site publishes are not in the warehouse, and 8 contractors have both pages on disk and no row at all.** *Ours, and a ruled trade-off.* **Superseded for those eight on 2026-09-01 by `R-80`: their exact omission is now proved and the parser repair is built; this paragraph remains the 2026-08-26 warehouse measurement.**
