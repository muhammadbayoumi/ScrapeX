...
**Captured 2026-08-26 · root cause proven · Ruled 2026-08-30 — `R-78` settles the shape, `R-81` moves it to the HEAD of the muqawil queue · In flight — the resolver landed as `#301`, the collector on branch `feat/the-crawl-button-drives-the-collector-it-needs`**
