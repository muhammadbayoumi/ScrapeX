...
origin/main` is the answer that cannot be. **It was stale again within the hour** —
this line said `4615a14` (#250) while #251 and #252 were already in, which is the
argument rather than a counter-example to it.
