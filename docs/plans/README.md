...
| plan | date | status |
|---|---|---|
| [2026-08-24-website-contact-linkedin-and-run-100.md](2026-08-24-website-contact-linkedin-and-run-100.md) | 2026-08-24 | **LIVE.** `REQ-44` / `R-51` — the matched official website supplies direct LinkedIn company and contact evidence without pretending to be an independent LinkedIn provider. The first gate is a deterministic, geographically spread 100-record run through the real enrichment job service; fixture tests alone do not close it |
