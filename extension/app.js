...
async function loadCrawlSettings() {
  ...
  // "6" REPEATED HERE AND NOWHERE ELSE IN THIS FILE, and it is a rendering fallback
  // rather than a second definition of the default: the engine answers with its own
  // catalogue value, and this is only what the field shows if the answer is missing a
  // key -- an engine older than this panel.
  $("directory_crawl_workers").value = value("directory_crawl_workers") || "6";
