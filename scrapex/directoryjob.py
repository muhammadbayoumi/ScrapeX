...
from . import contractors, db as dbmod, directories
...
#: default, with the measurement that chose it, and `workers_for` reads it from there --
#: so raising or lowering the default is one edit in one file. A constant here beside a
#: duplicate of itself in the catalogue is the drift `R-80` is about, at the smallest
#: possible scale.
