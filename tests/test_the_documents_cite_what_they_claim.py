...
PINNED = (
    ...
    ("docs/STATE.md", "scrapex/webui/app.py", 1679, '"latest_extension_version": VERSION'),
    ("docs/STATE.md", "extension/app.js", 607, "latest_extension_version"),
    ("docs/STATE.md", "scrapex/version.py", 76, 'VERSION = "'),
    ("docs/RULINGS.md", "scrapex/webui/app.py", 1679, '"latest_extension_version": VERSION'),
    ...
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 1690, '"worker_alive"'),
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 2760, "def _about("),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 4729,
    ...
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 3005, "if source_key not in known:"),
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 1182,
    ...
    # this line at all.
    ("docs/BACKLOG.md", "extension/app.js", 4617, "const last = s.last_success;"),
