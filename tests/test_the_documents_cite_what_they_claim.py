...
PINNED = (
    ...
    ("docs/STATE.md", "extension/app.js", 1586, "async function loadSourceColumns("),
    ("docs/APPROACHES.md", "extension/app.js", 1586, "async function loadSourceColumns("),
    ("docs/APPROACHES.md", "extension/app.js", 1625, "async function saveSourceColumns("),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 3408, 'text: "Not detected"'),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 4778,
    ...
    # this line at all.
    ("docs/BACKLOG.md", "extension/app.js", 4650, "const last = s.last_success;"),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 3554, "latest.version"),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 948,
     "function setupFinanceConverterSelect("),
    ("docs/BACKLOG.md", "extension/app.js", 2000, "function setupRunModeSelect("),
...
PINNED_WITHOUT_A_CITATION = frozenset((
    # THE SAME FOUR ORPHANS, MOVED RATHER THAN REPAIRED. `OP-132` added six lines
    # to `extension/app.js`, which slid every citation below them; these rows still
    # guard nothing, so the set has not shrunk and must not be read as having done.
    ("docs/APPROACHES.md", "extension/app.js", 1625),
    ("docs/BACKLOG.md", ".github/workflows/release-engine.yml", 553),
    ("docs/BACKLOG.md", "db/engine/schema.sql", 122),
    ("docs/BACKLOG.md", "db/engine/schema.sql", 843),
    ("docs/BACKLOG.md", "extension/app.js", 3554),
    ("docs/BACKLOG.md", "extension/app.js", 4650),
    ("docs/BACKLOG.md", "extension/app.js", 4778),
