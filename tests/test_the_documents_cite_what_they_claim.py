...
PINNED = (
    ...
    ("docs/STATE.md", "scrapex/webui/app.py", 1726, '"latest_extension_version": VERSION'),
    ("docs/STATE.md", "extension/app.js", 612, "latest_extension_version"),
    ("docs/STATE.md", "scrapex/version.py", 76, 'VERSION = "'),
    ("docs/RULINGS.md", "scrapex/webui/app.py", 1726, '"latest_extension_version": VERSION'),
    ...
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 1737, '"worker_alive"'),
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 2807, "def _about("),
    ...
    ("docs/BACKLOG.md", "extension/app.js", 4747,
    ...
    ("docs/BACKLOG.md", "scrapex/webui/app.py", 3177, "if source_key not in known:"),
    ...
    # this line at all.
    ("docs/BACKLOG.md", "extension/app.js", 4636, "const last = s.last_success;"),
